...
To check your total attendance, login at www.anukalpthakur.world
...
while True:
    ...
    for face in faces:
        ...
        if face_enc and face_recognition.compare_faces([known_encoding], face_enc[0])[0]:
            ...
            if blink_detected and not otp_verified:
                cv2.putText(img, f"OTP: {otp}", (x - 50, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                ...
                with sr.Microphone() as source:
                    ...
                    try:
                        ...
                        if spoken_text == otp:
                            ...
                            print("❌ OTP Mismatch! Try Again.")
                    except:
                        print("❌ Could not recognize speech.")

            if blink_detected and otp_verified and not attendance_marked:
